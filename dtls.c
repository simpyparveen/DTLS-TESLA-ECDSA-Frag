...
#define DTLS_CKXEC_LENGTH (1 + 1 + DTLS_EC_KEY_SIZE + DTLS_EC_KEY_SIZE + DTLS_TESLA_SYN_LENGTH + 136 + 21000) //+ DTLS_TESLA_SYN_LENGTH + 136(ECDSA signature+public key of signature)is added by simpy
...
check_client_keyexchange(dtls_context_t *ctx,
    ...
    if (is_tls_psk_with_aes_128_ccm_8(handshake->cipher)) {
        ...
        if (DTLS_HS_LENGTH + DTLS_CKXPSK_LENGTH_MIN + id_length + DTLS_TESLA_SYN_LENGTH + 136 +21000 != length) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //Sending extra 21000 Bytes here nby Simpy
    uint8_t extra[21000];
    dtls_fill_random(extra, 21000);
    memcpy(p,extra,21000);
    p+=21000;
...
//hashing data
            ...
            p = p + (data_length - DTLS_TESLA_SYN_LENGTH- 136 -21000);// Start of tesla+ ecdsa sign with pubkey is 128bytes
            q = p;
...
///Getting ecdsa
            ...
            // extra
            // uint8_t
            //Receiving extra 21000 Bytes here nby Simpy
            uint8_t extra[21000];
            //dtls_fill_random(extra, 21000);
            memcpy(extra,p,21000);
            p+=21000;
